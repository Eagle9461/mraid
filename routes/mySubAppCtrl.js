...
module.exports = {
  ...
  async getDeviceInfo(req, res, next) {
    try {
      let resources = await asyncResources.getDeviceInfo()
  ...
  async handleEvent(req, res, next) {
    try {
      let result = await asyncResources.handleEvent(req.body)
  ...
  async getImgUrl(req, res, next) {
    try {
      let resources = await asyncResources.sendImgUrl()
      res.status(200).send(resources)
    } catch (e) {
      next(e)
    }
